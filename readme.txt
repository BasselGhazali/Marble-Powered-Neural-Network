...
5) Use the "weight", "threshold" and "multiplier" g-code files to print as many components as required. Each print contains all the components needed by that unit. A single print gives the complete unit which can be assembled.
